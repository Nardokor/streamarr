...
namespace Streamarr.Core.HealthCheck
{
    public class ServerSideNotificationService : HealthCheckBase
    {
        ...
        private readonly IStreamarrCloudRequestBuilder _cloudRequestBuilder;
        private readonly IConfigFileProvider _configFileProvider;
        private readonly Logger _logger;

        public ServerSideNotificationService(IHttpClient client, IStreamarrCloudRequestBuilder cloudRequestBuilder, IConfigFileProvider configFileProvider, ILocalizationService localizationService, Logger logger)
