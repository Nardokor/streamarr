...
using Streamarr.Core.Download.Clients.Vuze;
using Streamarr.Core.Test.Download.DownloadClientTests.TransmissionTests;

namespace Streamarr.Core.Test.Download.DownloadClientTests.VuzeTests
{
    [TestFixture]
