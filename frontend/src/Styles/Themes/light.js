const streamarrBlue = '#35c5f4';
const streamarrAlternateBlue = '#2193b5';
const darkGray = '#888';
...
module.exports = {
  ...
  themeBlue: streamarrBlue,
  themeAlternateBlue: streamarrAlternateBlue,
  themeRed: '#c4273c',
  ...
  // Header
  pageHeaderBackgroundColor: streamarrAlternateBlue,
