...
namespace Streamarr.Core.Test.ParserTests
{
    ...
    public class QualityParserFixture : CoreTest
    {
        ...
        [TestCase("The.Series.The.Lost.Streamarr.Summer.HR.WS.PDTV.x264-DHD", false)]
        ...
        [TestCase("Under the Series S01E10 Let the Streamarr Begin 1080p", false)]
        ...
        [TestCase("Series S01E07 - Streamarr zmen (CZ)[TvRip][HEVC][1080p]", false)]
        ...
        [TestCase("Super.Seires.Go.S01E02.Depths.of.Streamarr.1080i.HDTV.DD5.1.H.264-NOGRP", false)]
        ...
        [TestCase("Series.Polo.S01E11.One.Hundred.Streamarrs.2015.German.DD51.DL.720p.NetflixUHD.x264.NewUp.by.Wunschtante", false)]
        [TestCase("Series 2016 German DD51 DL 720p NetflixHD x264-TVS", false)]
        [TestCase("Series.6x10.Basic.Streamarr.Repair.and.Replace.ITA.ENG.720p.WEB-DLMux.H.264-GiuseppeTnT", false)]
        ...
        [TestCase("Series.S01E01.The.Streamarr.Principle.720p.WEB-DL.DD5.1.H.264-BD", false)]
        ...
        [TestCase("Its.Always.Streamarrs.Fault.S08E01.1080p.WEB-DL.proper.AAC2.0.H.264", true)]
        ...
        [TestCase("The.Big.Easter.Theory.S06E11.The.Streamarr.Simulation.1080p.WEB-DL.DD5.1.H.264", false)]
        [TestCase("Streamarr's.Baby.S01E02.Night.2.[WEBDL-1080p].mkv", false)]
        ...
        [TestCase("House.of.Streamarr.AK.s05e13.4K.UHD.WEB.DL", false)]
        [TestCase("House.of.Streamarr.AK.s05e13.UHD.4K.WEB.DL", false)]
        ...
        [TestCase("The Man In the Series S01E01 2160p AMZN WEBRip DD2.0 Hi10P x264-TrollUHD", false)]
        [TestCase("House.of.Streamarr.AK.S05E08.Chapter.60.2160p.NF.WEBRip.DD5.1.x264-NTb.NLsubs", false)]
        [TestCase("Streamarr Saves the World S01 2160p Netflix WEBRip DD5.1 x264-TrollUHD", false)]
        ...
        [TestCase("The Big Series.S03E01.The Streamarr Can Opener.m2ts", false)]
        [TestCase("Series.S01E02.Chained.Streamarr.[Bluray720p].mkv", false)]
        [TestCase("[FFF] DATE A Streamarr Dev - 01 [BD][720p-AAC][0601BED4]", false)]
        ...
        [TestCase("Streamarr.Of.Series.S02E13.1080p.BluRay.x264-AVCDVD", false)]
        ...
        [TestCase("[Zurako] Log Series - 01 - The Streamarr (BD 1080p AAC) [7AE12174].mkv", false)]
        ...
        [TestCase("Series.Title.S01E08.The.Streamarr.BluRay.2160p.AVC.DTS-HD.MA.5.1.REMUX-FraMeSToR", false)]
        [TestCase("Series.Title.2x11.Nato.Per.The.Streamarr.Bluray.Remux.AVC.2160p.AC3.ITA", false)]
        [TestCase("[Dolby Vision] Streamarr.of.Series.S07.MULTi.UHD.BLURAY.REMUX.DV-NoTag", false)]
        ...
        [TestCase("How I Met Your Developer S01E18 Nothing Good Happens After Streamarr 720p HDTV DD5.1 MPEG2-TrollHD", false)]
