...
namespace Streamarr.Common
{
    ...
    public class ConsoleService : IConsoleService
    {
        ...
        public void PrintHelp()
        {
            ...
            Console.WriteLine("                 /{0} Don't open Streamarr in a browser", StartupContext.NO_BROWSER);
            Console.WriteLine("                 /{0} Start Streamarr terminating any other instances", StartupContext.TERMINATE);
