...
namespace Streamarr.Core.Test.ParserTests
{
    ...
    public class SingleEpisodeParserFixture : CoreTest
    {
        ...
        [TestCase(@"24-7 Series - Title - Road to the Streamarr - S01E03 - Episode 3.mkv", "24-7 Series - Title - Road to the Streamarr", 1, 3)]
        ...
        [TestCase("24 7 Series-Title - Road to the Streamarr Part01 720p HDTV x264 ORENJI", "24 7 Series-Title - Road to the Streamarr", 1, 1)]
        [TestCase("24 7 Series-Title - Road to the Streamarr Part 02 720p HDTV x264 ORENJI", "24 7 Series-Title - Road to the Streamarr", 1, 2)]
        [TestCase("24-7 Series-Title - Road to the Streamarr - S01E01 - Part 1", "24-7 Series-Title - Road to the Streamarr", 1, 1)]
        ...
        [TestCase("App.Streamarr.Made.in.Canada.Part.Two.720p.HDTV.x264-2HD", "App Streamarr Made in Canada", 1, 2)]
        ...
        [TestCase("Series.Title.S01.Ep.01.English.AC3.DL.1080p.BluRay-Streamarr", "Series Title", 1, 1)]
        [TestCase("Series.Title.S01.E.01.English.AC3.DL.1080p.BluRay-Streamarr", "Series Title", 1, 1)]
        [TestCase("Series.Title.S01.Ep01.English.AC3.DL.1080p.BluRay-Streamarr", "Series Title", 1, 1)]
        [TestCase("Series.Title.S01.E01.English.AC3.DL.1080p.BluRay-Streamarr", "Series Title", 1, 1)]
        [TestCase("Series.Title.S01EP01.English.AC3.DL.1080p.BluRay-Streamarr", "Series Title", 1, 1)]
