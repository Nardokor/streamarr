...
namespace Streamarr.Common.Test.InstrumentationTests
{
    ...
    public class CleanseLogMessageFixture
    {
        ...
        // Plex
        [TestCase(@" http://localhost:32400/library/metadata/12345/refresh?X-Plex-Client-Identifier=1234530f-422f-4aac-b6b3-01233210aaaa&X-Plex-Product=Streamarr&X-Plex-Platform=Windows&X-Plex-Platform-Version=7&X-Plex-Device-Name=Streamarr&X-Plex-Version=3.0.3.833&X-Plex-Token=mySecret")]
        ...
        // Webhooks - Notifiarr
        [TestCase(@"https://xxx.yyy/api/v1/notification/streamarr/9pr04sg6-0123-3210-imav-eql2tyu8xyui")]
