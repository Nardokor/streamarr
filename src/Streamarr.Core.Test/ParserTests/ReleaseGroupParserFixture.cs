...
namespace Streamarr.Core.Test.ParserTests
{
    ...
    public class ReleaseGroupParserFixture : CoreTest
    {
        ...
        [TestCase("Who.is.Streamarr.S01E01.INTERNAL.720p.HDTV.x264-aAF-RakuvUS-Obfuscated", "aAF")]
        [TestCase("Deadly.Development.S01E10.Sink.With.Code.1080p.AMZN.WEB-DL.DDP5.1.H.264-NTG-WhiteRev", "NTG")]
        [TestCase("The.Streamarr.Series.S09E12.Developers.REPACK.1080p.AMZN.WEB-DL.DD.5.1.H.264-CasStudio-BUYMORE", "CasStudio")]
        ...
        [TestCase("Absolute.Series.S02E06.The.House.of.Streamarr.DVDRip.x264-MaG-Chamele0n", "MaG")]
        ...
        [TestCase("[FFF] Series Title!! - S01E11 - Someday, With Streamarr", "FFF")]
        [TestCase("[HorribleSubs] Series Title!! - S01E12 - Streamarr Going Well!!", "HorribleSubs")]
        [TestCase("[Anime-Koi] Series Title - S01E06 - Guys From Streamarr", "Anime-Koi")]
        [TestCase("[Anime-Koi] Series Title - S01E07 - A High-Grade Streamarr", "Anime-Koi")]
